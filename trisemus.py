...
def generateKeyMatrix(keyword):
    start_alphabet = "АБВГДЕЖЗИКЛМНОПРЦЧШЩЫЬЭЮЯ"
...
if __name__ == '__main__':
    key = generateKeyMatrix('ПРОГРАММИРОВАНИЕ')
    secret = encrypt('УСПЕХ – ЭТО КОГДАТЫ ДЕВЯТЬ РАЗ УПАЛ, НО ДЕСЯТЬ РАЗ ПОДНЯЛСЯ', key)
    print(secret)
